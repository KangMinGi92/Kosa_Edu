...
public class CollectionStreamTest2 {
	...
	public static void main(String[] args) {
		List<String> fruits = Arrays.asList("Apple","Melon","Banana","Apple","Orange","Grape","Grape","Water Melon","Banana");
...
//		strStream.forEach(System.out::println);
		...
		//중복된 값은 없애고, 값중에서 6개만 추출, 정렬해서 출력
