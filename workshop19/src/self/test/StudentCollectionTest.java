...
public class StudentCollectionTest {
	public static void main(String[] args) {
		...
		List<Student> maleList = totalList.stream().filter(e->e.getGender().equals("남")).toList();
		...
		.forEachOrdered(e->System.out.println(e.getName()+e.getScore()));
		...
		Map<String, Integer> map =  totalList.stream().collect(Collectors.toMap(e->e.getName(), e->e.getScore()));
